...
NumberValue
  = DecimalValue / IntegerValue / OctalValue

DecimalValue
  = decimal:(head:Digit+ "." tail:Digit+)
    {
...
IntegerValue
  = !Alpha first:DigitWithoutZero digits:Digit* !NonTerminator
    { return parseInt(first + digits.join(''), 10) }

OctalValue
  = !Alpha '0' digits:Digit+ !NonTerminator
    {
